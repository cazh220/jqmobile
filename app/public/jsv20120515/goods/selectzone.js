...
function SelectZone()
{
   ...
   */
/*  this.loadOptions = function(act, filters, fuc)
  {
    Ajax.call(this.filename+"&do="+fuc+"&act=" + act, filters, this.loadOptionsResponse, "GET", "JSON");
  }*/
  ...
  this.dropItem = function(all, act)
  {
	...
	//alert(this.filename + "&act="+act+"&drop_ids=" + arr.toJSONString());
