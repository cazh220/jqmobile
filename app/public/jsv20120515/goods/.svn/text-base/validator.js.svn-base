...
var Validator = function(name)
{
  ...
  */
  this.islt = function(controlIdStart, controlIdEnd, msg)
  {
	...
	var ar_start = start.value.split("-");
	var starttime = new Date(ar_start[0],ar_start[1],ar_start[2]);
	starttime = starttime.getTime();
	
	var ar_end = end.value.split("-");
	var endtime = new Date(ar_end[0],ar_end[1],ar_end[2]);
