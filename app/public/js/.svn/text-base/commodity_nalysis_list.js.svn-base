...
$(function(){
	...
	$('#export_data').click(function(){
		//var s = $(this).siblings('input[type=hidden][name=pg]').val();
		var count = $("input[type=hidden][name=pg]").val()
		
		window.location.href = './commodityanalysis.php?do=QueryGoods&act=export&size='+count;
