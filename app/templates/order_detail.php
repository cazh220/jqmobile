		...
		<ul data-role="listview">
			...
			<li>
				<div class="list_product">
					...
					<div class="attr">产品名称：{$item.gift_name}<br> 产品规格：{$item.gift_intro}<br> 兑换积分：{$item.credits}<br> 数量：<span class="buy_num_css" onclick="subplus()"><img src="images/subplus.png" width="20px" height="20px" style="vertical-align: middle;"></span><span id="buy_num">1</span><span class="buy_num_css" onclick="plus()"><img src="images/plus.png" width="20px" height="20px" style="vertical-align: middle;"></span></div>
				</div>
			</li>
			{/foreach}
			{/if}
