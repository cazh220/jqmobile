...
<div data-role="page">
  ...
  <div data-role="content" data-theme="b">
    ...
    <form data-ajax="false">
		...
		<label style="margin-left:0px"><a href="user.php?do=findPwd" style="text-decoration:none;">忘记密码?</a></label><label style="float:right"><a data-ajax="false" href="user.php?do=bind_mobile" style="text-decoration:none;">马上注册</a></label>
    </form>
  </div>
</div>
