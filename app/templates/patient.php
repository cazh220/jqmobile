...
<div data-role="page">
  ...
  <div data-role="content" data-theme="c">
    <form id="patient_form" method="post" action="patient.php?do=addpatient" data-ajax="false" enctype="multipart/form-data">
      ...
      <div style="text-align: right; width: 50%; float: left;"><a href="#" data-role="button">更改</a></div><div style="text-align: center; width: 50%; float: left;"><a href="#" data-role="button" onclick="dodubmit()">提交</a></div>
