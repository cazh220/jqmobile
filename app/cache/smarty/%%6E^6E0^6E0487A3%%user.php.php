<?php /* Smarty version 2.6.10, created on 2017-07-25 01:07:52
...
<div data-role="page" id="pageone">
  ...
  <div data-role="content" data-theme="d">
    <div class="to"></div>
	<div class="user_account"><?php echo $this->_tpl_vars['user_list']['realname']; ?>
</div>
	<div class="base_info"><label style="margin-left:0px">已录入：<?php echo $this->_tpl_vars['user_list']['exchanged_credits']; ?>
</label><label style="float:right">积分余额：<?php echo $this->_tpl_vars['user_list']['left_credits']; ?>
</label></div>
