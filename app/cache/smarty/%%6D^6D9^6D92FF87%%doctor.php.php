<?php /* Smarty version 2.6.10, created on 2017-08-02 10:29:45
...
" width="100px" height="100px"></div>
      ...
      <div style="text-align: right; width: 50%; float: left;"><a href="patient.php" data-role="button">提交</a></div><div style="text-align: center; width: 50%; float: left;"><a href="doctor.php?do=correction&qrcode=<?php echo $this->_tpl_vars['qrcode']; ?>
" data-role="button">纠错</a></div>
