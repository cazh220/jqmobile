<?php /* Smarty version 2.6.10, created on 2017-07-27 18:07:25
  ...
  <div data-role="content" data-theme="c">
    <form method="post" action="demoform.asp">
      <div data-role="fieldcontain">
      	<div style="height: 50px; text-align: right; width: 25%; float: left; line-height: 50px">医疗机构：</div><div style="height: 50px; text-align: center; width: 75%; float: left; line-height: 50px"><input type="text" name="fullname" id="fullname" placeholder="技工录入自动获取"></div>
        <div style="height: 50px; text-align: right; width: 25%; float: left; line-height: 50px">医疗专家：</div><div style="height: 50px; text-align: center; width: 75%; float: left; line-height: 50px"><input type="text" name="fullname" id="fullname" placeholder="技工录入自动获取"></div>
        <div style="height: 50px; text-align: right; width: 25%; float: left; line-height: 50px">患者姓名：</div><div style="height: 50px; text-align: center; width: 75%; float: left; line-height: 50px"><input type="text" name="fullname" id="fullname" placeholder="技工录入自动获取"></div>
        ...
        <div style="height: 50px; text-align: right; width: 25%; float: left; line-height: 50px">患者年龄：</div><div style="height: 50px; text-align: center; width: 75%; float: left; line-height: 50px"><input type="text" name="fullname" id="fullname" placeholder="技工录入自动获取"></div> 
        ...
        <div style="height: 100px; text-align: right; width: 25%; float: left; line-height: 100px">修复体图片：</div><div style="height: 100px; text-align: center; width: 75%; float: left; line-height: 100px"><img src="images/3.png" width="100px" height="100px"></div>
