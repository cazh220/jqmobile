<?php /* Smarty version 2.6.10, created on 2017-08-02 00:09:45
...
"><?php echo $this->_tpl_vars['item']['name']; ?>
		...
		<input type="hidden" id="mobile" name="mobile" value="<?php echo $this->_tpl_vars['mobile']; ?>
" >
		<input type="hidden" id="username" name="username" value="<?php echo $this->_tpl_vars['username']; ?>
" >
    </form>
  </div>
</div>
